...
heart$chd <- ifelse(heart$chd == "no", 0, 1)

# Try using best subsets (exhaustive) with the BIC metric
...
```{r, fig.align='center'}
heart_logistic <- glm(data = heart, formula = chd ~ ., family = binomial(link="logit"))
